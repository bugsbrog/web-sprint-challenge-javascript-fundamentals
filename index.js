...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction starts before the curly brackets on myFunction end.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(name, scientific){
    ...
    return `name: ${this.name}, scientific: ${this.scientific}`
  }
  ...
  */
  ...
  function lowPopulationAnimals(animalNames){
   const allPopulation = animalNames.filter(function(item){
   })
